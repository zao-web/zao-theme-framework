<?php
/**
 * Gutenberg Starter Theme: Color Patterns
 *
 * @package WordPress
 * @subpackage gutenberg-starter-theme
 * @since 1.0
 */
 ...
 */
function gutenberg_starter_theme_custom_colors_css() {
	...
	/**
	 * Filter Gutenberg Starter Theme default saturation level.
	 *
	 * @since Gutenberg Starter Theme 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'gutenberg_starter_theme_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter Gutenberg Starter Theme default selection saturation level.
	 *
	 * @since Gutenberg Starter Theme 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'gutenberg_starter_theme_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter Gutenberg Starter Theme default lightness level.
	 *
	 * @since Gutenberg Starter Theme 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'gutenberg_starter_theme_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter Gutenberg Starter Theme default hover lightness level.
	 *
	 * @since Gutenberg Starter Theme 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'gutenberg_starter_theme_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter Gutenberg Starter Theme default selection lightness level.
	 *
	 * @since Gutenberg Starter Theme 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'gutenberg_starter_theme_custom_colors_lightness_selection', 90 );
	...
	/**
	 * Filters Gutenberg Starter Theme custom colors CSS.
	 *
	 * @since Gutenberg Starter Theme 1.0
	 *
	 ...
	 */
	return apply_filters( 'gutenberg_starter_theme_custom_colors_css', $theme_css, $primary_color, $saturation );
}
